...
@ReactModule(name = AWSRNS3TransferUtilityModule.NAME)
public class AWSRNS3TransferUtilityModule extends ReactContextBaseJavaModule {
  private final ReactApplicationContext reactContext;
  private TransferUtility transferUtility;
  private AmazonS3Client s3Client;
  private static final ConcurrentHashMap<String, ConcurrentHashMap<String, Object>> requestMap = new ConcurrentHashMap<String, ConcurrentHashMap<String, Object>>();

  private String identityPoolId;
  private String region;
  private String googleJWTToken;

  private static final String TAG = "AWSS3TransferUtility";
  ...
  public static final String NAME = "S3TransferUtilityV2";
      ...
      this.transferUtility.upload(bucket, key, mainFile).setTransferListener(new TransferListener() {
        ...
        public void onStateChanged(int id, TransferState state) {
          ...
          if(state == TransferState.COMPLETED){
           Log.d(TAG, "Upload Successful for request id: "+requestID+" !!!");
          }
        }
